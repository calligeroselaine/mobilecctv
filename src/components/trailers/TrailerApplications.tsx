...
import { applications, trailerCopy } from "@/lib/trailer-content";

export function TrailerApplications() {
  return (
    <section id="uses" style={{ background: "#E6E2DA", color: "#141619", scrollMarginTop: 140 }}>
      <div className="mx-auto max-w-[1440px] px-5 py-14 sm:px-8 sm:py-20">
        ...
        <a href="#adco" className="mt-10 inline-flex items-center gap-2 text-sm font-semibold hover:text-[#4588c6]">
          See it in two real deployments <ArrowDown className="h-4 w-4" aria-hidden="true" />
        </a>
      </div>
    </section>
  );
