  ...
  return (
    <section id="enquire" style={{ background: "#16191C", color: "#F2F0EB", scrollMarginTop: 140 }}>
      <div className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 sm:py-28">
        ...
        >
          Built for the places fixed CCTV can&rsquo;t reach.
        </h2>
        <p className="mt-8 max-w-[520px] text-lg leading-[1.5] text-[#E3E1DC]">
          A versatile surveillance system for the sites your fixed cameras can&rsquo;t cover. Tell us about your site and we&rsquo;ll recommend a pole camera, a trailer, or a mix of both.
        </p>
