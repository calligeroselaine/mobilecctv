  ...
  return (
    <section style={{ background: "#16191C", color: "#F2F0EB" }} className="overflow-hidden">
      <div className="mx-auto max-w-[1440px] px-5 pt-10 sm:px-8 sm:pt-14">
        ...
        <h1
          className="relative z-[2] mt-5 mb-8 font-bold uppercase leading-[0.84] tracking-[-0.03em] pointer-events-none sm:mb-10"
      ...
      <div className="relative z-[1] mx-auto max-w-[1440px] px-5 sm:px-8" style={{ marginTop: "clamp(-60px,-4vw,-24px)" }}>
      ...
      <div className="mx-auto grid max-w-[1440px] grid-cols-1 items-end gap-10 px-5 py-12 sm:px-8 sm:py-16 md:grid-cols-2">
        <p className="max-w-[640px] font-normal leading-[1.2] tracking-[-0.01em]" style={{ fontSize: "clamp(24px,2.6vw,36px)" }}>
          {copy.heroLead}
        </p>
