...
export function MocRamadan() {
  ...
  return (
    <section id="ramadan" style={{ background: "#0F1113", color: "#F2F0EB", scrollMarginTop: 60 }}>
      ...
      <div id="network" className="mx-auto grid max-w-[1440px] grid-cols-1 gap-16 px-5 pb-16 pt-16 sm:px-8 sm:pb-24 sm:pt-24 lg:grid-cols-2 lg:gap-24" style={{ scrollMarginTop: 60 }}>
        <div>
